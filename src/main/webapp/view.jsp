  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.jsp" style="color: white; font-size: 17px;">Add Course</a>
        </li>
        <li class="nav-item">
...
<table class="table">
  ...
  <c:forEach items="${courses}" var="course">
      ...
      <td scope="col">
        ...
        <a href="?action=view&courseid=<c:out value = "${course.courseid }"/>">
        <i class="fa fa-eye" aria-hidden="true"></i></a>
        <a href="?action=edit&courseid=<c:out value = "${course.courseid }"/>">
